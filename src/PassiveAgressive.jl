...
PAClassifier(in_::Int=1; kwargs...) = PAClassifier(Float32, in_; kwargs...)
PAClassifier(::Type{T}, in_::Int=1; type::Symbol=:base, C=1) where {T<:AbstractFloat} = begin
...
PARegressor(in_::Int=1; kwargs...) = PARegressor(Float32, in_; kwargs...)
PARegressor(::Type{T}, in_::Int=1; type::Symbol=:base, ϵ=0.1, C=1) where {T<:AbstractFloat} = begin
...
PAUniclassClassifier(in_::Int=1; kwargs...) = PAUniclassClassifier(Float32, in_; kwargs...)
PAUniclassClassifier(::Type{T}, in_::Int=1; type::Symbol=:base, ϵ=0.1, B=1e10, C=1, adaptive::Bool=true) where {T<:AbstractFloat} = begin
    if adaptive
